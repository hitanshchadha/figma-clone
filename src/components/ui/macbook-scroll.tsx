...
export const Keypad = () => {
  ...
  return (<div className=" place-content-center flex w-[50%] z-50 place-items-center">
    <div className="   keyboard ml-5  overflow-hidden rounded-md bg-[#050505] mx-1 p-1 tracking-normal">
      ...
      <Row>
        <KBtn keyy="Escape"
          className="w-10 items-end justify-start pl-[4px] pb-[2px] tracking-normal"
        ...
        <KBtn keyy="F1">
          ...
          <span className="inline-block mt-1 tracking-normal">F1</span>
        </KBtn>
      ...
      <Row>
        ...
        <KBtn keyy="BracketLeft">
          <span className="block">{`{`}</span>
          <br />
          <span className="block">{`[`}</span>
        </KBtn>
        <KBtn keyy="BracketRight">
          <span className="block">{`}`}</span>
          <br />
          <span className="block">{`]`}</span>
        </KBtn>
      ...
      {/* sixth Row */}
      <Row>
        <KBtn keyy="Function" className="" childrenClassName="h-full justify-between py-[4px]">
        ...
        <KBtn keyy="ControlLeft" className="" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex justify-end w-full pr-1">
        ...
        <KBtn keyy="Space" className="w-[8.2rem]"></KBtn>
        <KBtn
          className="w-8"
          childrenClassName="h-full justify-between py-[4px]"
        >
        ...
        <div className="w-[4.9rem] mt-[2px] h-6 p-[0.5px] rounded-[4px] flex flex-col justify-end items-center">
          <KBtn keyy="ArrowUp" className="w-6 h-3">
            <IconCaretUpFilled className="h-[6px] w-[6px]" />
          </KBtn>
          <div className="flex">
            <KBtn keyy="ArrowLeft" className="w-6 h-3">
              <IconCaretLeftFilled className="h-[6px] w-[6px]" />
            </KBtn>
            <KBtn keyy="ArrowDown" className="w-6 h-3">
              <IconCaretDownFilled className="h-[6px] w-[6px]" />
            </KBtn>
            <KBtn keyy="ArrowRight" className="w-6 h-3">
...
export const KBtn = (
  ...
  backlit?: boolean;
    ...
    useEffect(() => {
      document.addEventListener('keyup', keyreleaseevent)
  }, [])
  ...
  return (
    <div id="hello"
      className={cn(
        " p-[0.5px] rounded-[4px]",
        backlit && "bg-white/[0.2] shadow-xl shadow-white  hover:shadow-[#3B82F6]  ",colour)}
    >
      <div
        className={cn(
